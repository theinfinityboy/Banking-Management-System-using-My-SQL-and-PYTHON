...
while True:
    ...
    print("*******************  Welcome To Students Bank of IITP  *******************")
                    ...
                    if(ch1==1):
                        ...
                        if(ch2==1):
                            try:
                                ...
                                mycon.commit()
                                print("_________________________________________________________________________")
                                print ("   ****Hurrah !!! Name is Updated Successfully***   :) ")
                                print("_________________________________________________________________________")
                            except IndexError:
                            ...
                            try:
                                ...
                                mycon.commit()
                                print("_________________________________________________________________________")
                                print ("   ****Hurrah !!! UserName is Updated Successfully***   :) ")
                                print("_________________________________________________________________________")
                            ...
                            try:
                                ...
                                mycur.execute(us)
                                mycon.commit()
                                print ("Hurrah !!! Password is Updated Successfully")
                            except IndexError:
                                print("Oh Something Went Wrong")
                        elif(ch2==4):
                            while True:
                                try:
                                    ...
                                    mycon.commit()
                                    print("_________________________________________________________________________")
                                    print ("   ****Hurrah !!! Mobile Number is Updated Successfully***   :) ")
                                    print("_________________________________________________________________________")
                            ...
                            try:
                                ...
                                mycon.commit()
                                print("_________________________________________________________________________")
                                print("   *** Hurrah !!! Address is Updated Successfully ***  :) ") 
                                print("_________________________________________________________________________")
                            except IndexError:
                        ...
                        print("*************Thanks For Choosing Students Bank Of IITP *****************")
                        print("____________________________________________________________________________")
                        exit()
